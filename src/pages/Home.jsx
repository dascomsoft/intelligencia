  ...
  return (
    <section className="text-gray-800">
      <div>
        ...
        <section
          className="relative bg-center bg-no-repeat bg-cover bg-fixed text-white  pt-20 pb-15"
          style={{
            backgroundImage: `radial-gradient(rgba(20, 21, 51, 0.9), rgba(20, 21, 51, 0.5)), url(${background})`,
          }}
        >
          <div className="container mx-auto px-6">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">Bienvenue chez Intelligencia</h1>
        ...
        <div className="bg-gray-900 py-16 px-4 sm:px-6 lg:px-8">
          <h1 className="text-white text-3xl sm:text-4xl font-bold text-center mb-12" data-aos="fade-up">
          ...
          <div className="container px-6 mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg " data-aos="fade-up" data-aos-delay="100" >
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-white text-xl font-semibold">Immersion linguistique complète</h3>
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="200">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-white text-xl font-semibold">Cours certifiés et reconnus</h3>
                  <p className="text-gray-300 mt-2">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="300">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-white text-xl font-semibold">Suivi personnalisé</h3>
                  <p className="text-gray-300 mt-2">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="400">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-white text-xl font-semibold">Langues et opportunités</h3>
                  <p className="text-gray-300 mt-2">
        ...
        <section className="py-20 bg-gray-100">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-10">
              <h1 className="text-4xl font-bold text-gray-800" data-aos="fade-up">Ils ont réussi avec Intelligencia</h1>
            </div>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-indigo-900 text-white py-24 px-6 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Parlez l’Allemand et l’Italien avec Confiance</h1>
        ...
        <section className="py-20 px-6 bg-gray-100 ">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-6 rounded shadow">
              <h3 className="font-semibold text-xl mb-2">Accompagnement immigration</h3>
              <p>
                Nous vous assistons dans la constitution de vos dossiers de voyage vers l'Allemagne ou l'Italie.
              </p>
            </div>
            <div className="bg-white p-6 rounded shadow">
              <h3 className="font-semibold text-xl mb-2">Taux de réussite élevé</h3>
              <p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white shadow-xl rounded-2xl p-6 hover:shadow-2xl transition">
                <h2 className="text-xl font-semibold mb-4">🇩🇪 Cours d’Allemand</h2>
              ...
              {/* Carte Italien */}
              <div className="bg-white shadow-xl rounded-2xl p-6 hover:shadow-2xl transition">
                <h2 className="text-xl font-semibold mb-4">🇮🇹 Cours d’Italien</h2>
                <ul className="space-y-1">
                  <li>✅ Préparation : A1, A2, B1, B2</li>
                  <li>🕐 Cours du jour et du soir</li>
              ...
              {/* Carte Anglais */}
              <div className="bg-white shadow-xl rounded-2xl p-6 hover:shadow-2xl transition">
                <h2 className="text-xl font-semibold mb-4">🇬🇧 Cours d’Anglais</h2>
                <ul className="space-y-1">
